...
<div id="edit_form">
<form name="edit_user_transport" method="post">
<table>
   <tr>
      <td colspan="4"><h3><?php print $PALANG['pEdit_user_welcome']; ?></h3></td>
   </tr>
   <tr>
      <td colspan="4"><?php print $PALANG['pEdit_user_explanation']; ?></td>
   </tr>
   <tr>
      <td><?php print $PALANG['pEdit_user_localpart'] . ":"; ?></td>
      <td colspan="2"><input class="flat" type="text" name="fLocalpart" value="<?php print $tLocalpart; ?>" /></td>
      <td><?php print $PALANG['pEdit_user_localpart_text']; ?></td>
   </tr>
   <tr>
      <td><?php print $PALANG['pEdit_user_domain'] . ":"; ?></td>
      ...
      <td><?php print $PALANG['pEdit_user_domain_text']; ?></td>
   </tr>
   <tr>
      <td><?php print $PALANG['pEdit_user_description'] . ":"; ?></td>
      <td colspan="2"><input class="flat" type="text" name="fDescription" value="<?php print $tDescription; ?>" /></td>
      <td>&nbsp;</td>
   </tr>
   <tr>
      <td><?php print $PALANG['pEdit_user_relay'] . ":"; ?></td>
      <td><select class="flat" name="fNexthop_id">
      <?php
      ...
      <td><?php print $PALANG['pEdit_user_relay_text']; ?></td>
   </tr>
   <tr>
      <td colspan="4" class="hlp_center"><input type="submit" class="button" name="submit" value="<?php print $PALANG['pEdit_user_button']; ?>" /></td>
   </tr>
   <tr>
