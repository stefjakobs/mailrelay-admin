...
if (sizeof ($action_properties) > 0)
{
   ...
   print "      <td>" . $PALANG['pAdminList_action_modified'] . "</td>\n";
   ...
   foreach(array_keys($action_properties) as $i)
   {
      if ((is_array ($action_properties) and sizeof ($action_properties) > 0))
      {
         ...
         print "<td valign=\"top\"><a href=\"edit-action.php?id=" . $action_properties[$i]['id'] . "\">" . $action_properties[$i]['action'] . "</a></td>";
         print "<td valign=\"top\">" . $action_properties[$i]['description'] . "</td>";
         print "<td valign=\"top\">" . $action_properties[$i]['modified'] . "</td>";
         print "<td valign=\"top\" align=right>" . $action_properties[$i]['address'] . "</td>";
         print "<td valign=\"top\"><a href=\"edit-action.php?id=" . $action_properties[$i]['id'] . "\">" . $PALANG['edit'] . "</a></td>";
         print "<td valign=\"top\"><a href=\"delete.php?table=action&delete=" . $action_properties[$i]['id'] . "\" onclick=\"return confirm ('" . $PALANG['confirm'] . $PALANG['pAdminList_admin_action'] . ": " . $action_properties[$i]['action'] . "')\">" . $PALANG['del'] . "</a></td>";
         print "</tr>\n";
		}
   }
...
echo "<p><a href='create-action.php'>{$PALANG['pAdminMenu_create_action']}</a>";
?>
